...
REM
REM Generated by Vivado on Sun Dec 07 18:12:06 +0200 2025
...
echo "xvhdl --incr --relax -prj tb_cla_adder_16bit_vhdl.prj"
call xvhdl  --incr --relax -prj tb_cla_adder_16bit_vhdl.prj -log xvhdl.log
