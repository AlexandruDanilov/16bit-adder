...
REM
REM Generated by Vivado on Wed Nov 26 15:43:37 +0200 2025
...
echo "xvhdl --incr --relax -prj tb_full_adder_16bit_vhdl.prj"
call xvhdl  --incr --relax -prj tb_full_adder_16bit_vhdl.prj -log xvhdl.log
