...
REM
REM Generated by Vivado on Wed Nov 12 16:23:06 +0200 2025
...
echo "xvhdl --incr --relax -prj tb_full_adder_1bit_vhdl.prj"
call xvhdl  --incr --relax -prj tb_full_adder_1bit_vhdl.prj -log xvhdl.log
